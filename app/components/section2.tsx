    ...
    <NewSection>
      <div className="flex flex-col 1000px:flex-row gap-10 items-center justify-center">
        <div className="order-2 1000px:order-1 1000px:w-1/2 grid gap-2">
          ...
          <button className="w-max font-Satoshi_B rounded-md text-[18px] 1000px:px-[225px] px-[125px]  py-5  bg-gradient-to-r from-[#3D8BFF] to-[#AB23FF] mt-2 group relative overflow-hidden hover:to-[#3D8BFF] transition-all duration-500 ease-in-out">
  <span className="w-full absolute top-1/2 left-1/2 transform  -translate-x-1/2 -translate-y-1/2 transition-all duration-500 ease-in-out group-hover:translate-y-[-65px] ">
    Buy Creon Pass
  </span>
  <span className="w-full absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[100%] transition-all duration-500 ease-in-out group-hover:translate-y-[-7px] ">
    Buy Creon Pass
  </span>
</button>
